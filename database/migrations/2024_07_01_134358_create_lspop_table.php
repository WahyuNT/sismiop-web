...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('lspop', function (Blueprint $table) {
            ...
            $table->string('1_jenis_transaksi',10);
            ...
            $table->string('11_kondisi_pada_umumnya',10)->nullable();
            $table->string('12_konstruksi',10)->nullable();
            $table->string('13_atap',10)->nullable();
            $table->string('14_dinding',10)->nullable();
            $table->string('15_lantai',10)->nullable();
            $table->string('16_langit_langit',10)->nullable();
            ...
            $table->string('24_bahan_pagar',10)->nullable();
            ...
            $table->string('50_letak_tangki',10)->nullable();
