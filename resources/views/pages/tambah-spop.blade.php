                    ...
                    <div class="div">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                ...
                                <input class="form-control" name="2_nop_kabupaten" id="Kabupaten" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="Kecamatan">Kecamatan</label>
                                <input class="form-control" name="2_nop_kecamatan" id="Kecamatan" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="Gampong">Gampong</label>
                                <input class="form-control" name="2_nop_gampong" id="Gampong" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="Blok">Blok</label>
                                <input class="form-control" name="2_nop_blok" id="Blok" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="No.Urut">No.Urut</label>
                                <input class="form-control" name="2_no_urut" id="No.Urut" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="Kode">Kode</label>
                                <input class="form-control" name="2_nop_kode" id="Kode" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="provinsi">Provinsi</label>
                                <input class="form-control" name="3_nop_bersama_provinsi" id="provinsi" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="Kabupaten">Kabupaten</label>
                                <input class="form-control" name="3_nop_bersama_kabupaten" id="Kabupaten" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="Kecamatan">Kecamatan</label>
                                <input class="form-control" name="3_nop_bersama_kecamatan" id="Kecamatan" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="Gampong">Gampong</label>
                                <input class="form-control" name="3_nop_bersama_gampong" id="Gampong" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="Blok">Blok</label>
                                <input class="form-control" name="3_nop_bersama_blok" id="Blok" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="No.Urut">No.Urut</label>
                                <input class="form-control" name="3_no_urut" id="No.Urut" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                            <div class="col-lg-6 col-12 mb-2 px-3">
                                <label class="mb-1" for="Kode">Kode</label>
                                <input class="form-control" name="3_nop_bersama_kode" id="Kode" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-form">
                    <div class="d-flex flex-wrap">
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            ...
                            <input class="form-control" name="4_nop_asal" id="4_nop_asal" type="text"
                                placeholder="Masukkan Data" />
                        </div>
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            <label class="mb-1" for="5_no_sppt_lama">5. NO. SPPT LAMA</label>
                            <input class="form-control" name="5_no_sppt_lama" id="5_no_sppt_lama" type="text"
                                placeholder="Masukkan Data" />
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-form">
                <div class="d-flex flex-wrap">
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        ...
                        <input class="form-control" name="6_nama_jalan" id="6_nama_jalan" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        <label class="mb-1" for="7_blok_kav_nomor">7. BLOK / KAV / NOMOR</label>
                        <input class="form-control" name="7_blok_kav_nomor" id="7_blok_kav_nomor" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        <label class="mb-1" for="8_gampong">8. GAMPONG</label>
                        <input class="form-control" name="8_gampong" id="8_gampong" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                    <div class="col-6 d-flex flex-wrap">
                        ...
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            ...
                            <input class="form-control" name="9_rw" id="9_rw" type="text"
                                placeholder="Masukkan Data" />
                        </div>
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            <label class="mb-1" for="10_rt">10. RT</label>
                            <input class="form-control" name="10_rt" id="10_rt" type="text"
                                placeholder="Masukkan Data" />
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-form">
                <div class="d-flex flex-wrap">
                    <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                        ...
                        <select name="11_status" id="11_status" class="form-select">
                    ...
                    <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                        ...
                        <select name="12_pekerjaan" id="12_pekerjaan" class="form-select">
                            <option value="">Silahkan Pilih</option>
                    ...
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        ...
                        <input class="form-control" name="13_nama_subjek_pajak" id="13_nama_subjek_pajak" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        <label class="mb-1" for="14_npwp">14. NPWP</label>
                        <input class="form-control" name="14_npwp" id="14_npwp" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        <label class="mb-1" for="15_nama_jalan">15. NAMA JALAN</label>
                        <input class="form-control" name="15_nama_jalan" id="15_nama_jalan" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        <label class="mb-1" for="16_blok_kav_nomor">16. BLOK / KAV / NOMOR</label>
                        <input class="form-control" name="16_blok_kav_nomor" id="16_blok_kav_nomor" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        <label class="mb-1" for="17_gampong">17. GAMPONG</label>
                        <input class="form-control" name="17_gampong" id="17_gampong" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                    <div class="col-lg-6 col-12 d-flex flex-wrap">
                        ...
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            ...
                            <input class="form-control" name="18_rw" id="18_rw" type="text"
                                placeholder="Masukkan Data" />
                        </div>
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            <label class="mb-1" for="19_rt">19. RT</label>
                            <input class="form-control" name="19_rt" id="19_rt" type="text"
                                placeholder="Masukkan Data" />
                        </div>
                    </div>
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        <label class="mb-1" for="20_kecamatan_kabupaten_kota">20. KECAMATAN - KABUPATEN / KOTA (KODE
                            POS)</label>
                        <input class="form-control" name="20_kecamatan_kabupaten_kota" id="20_kecamatan_kabupaten_kota"
                            type="text" placeholder="Masukkan Data" />
                    </div>
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        <label class="mb-1" for="21_nomor_ktp">21. NOMOR KTP</label>
                        <input class="form-control" name="21_nomor_ktp" id="21_nomor_ktp" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                </div>
            </div>
            ...
            <div class="card card-form">
                <div class="d-flex flex-wrap">
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        ...
                        <input class="form-control" name="22_luas_tanah" id="22_luas_tanah" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        <label class="mb-1" for="23_zona_nilai_tanah">23. ZONA NILAI TANAH</label>
                        <input class="form-control" name="23_zona_nilai_tanah" id="23_zona_nilai_tanah" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                    <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                        <label for="24_jenis_tanah">24. JENIS TANAH</label>
                        <select name="24_jenis_tanah" id="24_jenis_tanah" class="form-select">
                            <option value="">Silahkan Pilih</option>
            ...
            <div class="card card-form">
                <div class="d-flex flex-wrap">
                    <div class="col-lg-6 col-12 px-3 mb-2">
                        ...
                        <input class="form-control" name="25_jumlah_bangunan" id="25_jumlah_bangunan" type="text"
                            placeholder="Masukkan Data" />
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex flex-wrap">
                    <div class="col-6 px-3">
                        ...
                        <div class="col-12">
                            ...
                            <input class="form-control" name="29_tanggal_petugas" id="29_tanggal_petugas" type="date"
                                placeholder="Masukkan Data" />
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <input class="form-control" name="31_nama_jelas_petugas" id="31_nama_jelas_petugas"
                                type="text" placeholder="Masukkan Data" />
                        </div>
                        <div class="col-12">
                            <label class="mb-1" for="32_nip_petugas">32. NIP</label>
                            <input class="form-control" name="32_nip_petugas" id="32_nip_petugas" type="text"
                                placeholder="Masukkan Data" />
                        </div>
                    </div>
                    <div class="col-6 px-3">
                        ...
                        <div class="col-12">
                            ...
                            <input class="form-control" name="29_tanggal_pejabat" id="29_tanggal_pejabat" type="text"
                                placeholder="Masukkan Data" />
                        </div>
                        <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input class="form-control" name="31_nama_jelas_pejabat" id="31_nama_jelas_pejabat"
                                    type="text" placeholder="Masukkan Data" />
                            </div>
                            <div class="col-12">
                                <label class="mb-1" for="32_nip_pejabat">32. NIP</label>
                                <input class="form-control" name="32_nip_pejabat" id="32_nip_pejabat" type="text"
                                    placeholder="Masukkan Data" />
                            </div>
                        </div>
                    </div>
