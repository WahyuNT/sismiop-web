        ...
        @elseif($idEdit != null)
            <div class="div">
                ...
                <div class="col-lg-5 col-6 mb-2  mt-3">
                    ...
                    <input required class="form-control" wire:model.defer="NM_KECAMATAN" name="2_nop_kabupaten"
                        type="text" placeholder="Masukkan Nama Kecamatan" />
                    @error('NM_KECAMATAN')
                ...
                <div class="col-lg-5 col-6 mb-2  mt-3">
                    ...
                    <select required wire:model.defer="KD_DATI2" class="form-select " aria-label=". example">
