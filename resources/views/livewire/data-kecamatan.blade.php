                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="">{{ $item->NM_KECAMATAN }}</td>
                                            <td class="">{{ $item->dati2->NM_DATI2 }}</td>
    ...
    @else
        <div class="div">
            ...
            <div class="col-lg-5 col-6 mb-2  mt-3">
                <label class="text-black  mb-1" for="2_nop_kabupaten">Nama Kecamatan</label>
                <input required class="form-control" wire:model.defer="NM_KECAMATAN" name="2_nop_kabupaten" type="text"
                    placeholder="Masukkan Nama Kecamatan" />
            </div>
            <div class="col-lg-5 col-6 mb-2  mt-3">
                <label class="text-black  mb-1" for="2_nop_kabupaten">Dati 2</label>
                <select required  wire:model.defer="KD_DATI2" class="form-select "
                    aria-label=". example">
                    <option value="" selected>Pilih DATI2</option>
            ...
            <div class="col-lg-5 col-6 mb-2  mt-3">
                ...
                <select required  wire:model.defer="KD_PROPINSI" class="form-select "
                aria-label=". example">
