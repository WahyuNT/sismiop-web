                    ...
                    <div class="card card-form">
                        <div class="col-lg-4 col-12 mb-2 px-1">
                            ...
                            <input {{ $disabled }} required maxlength="9" wire:model.defer="data.no_formulir"
                                class="form-control" name="no_formulir" id="no_formulir" type="text"
                                placeholder="..." />
                        </div>
                        <div class="div">
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="col-lg-1 col-12 mb-2 px-1">
                                        ...
                                        <input {{ $disabled }} class="form-control"
                                            wire:model.defer="data.3_nop_bersama_provinsi"
                                    ...
                                    <div class="col-lg-2 col-12 mb-2 px-1">
                                        ...
                                        <input {{ $disabled }} class="form-control"
                                            wire:model.defer="data.3_nop_bersama_kabupaten"
                                    ...
                                    <div class="col-lg-2 col-12 mb-2 px-1">
                                        ...
                                        <input {{ $disabled }} class="form-control"
                                            wire:model.defer="data.3_nop_bersama_kecamatan"
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            ...
                            <input {{ $disabled }} class="form-control" wire:model.defer="data.7_blok_kav_nomor"
                                name="7_blok_kav_nomor" id="7_blok_kav_nomor" type="text"
                                placeholder="Memuat..." />
                        </div>
                        <div class="col-lg-6 col-12 px-3 mb-2">
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            ...
                            <input {{ $disabled }} class="form-control"
                                ...
                                id="13_nama_subjek_pajak" type="text" placeholder="Memuat..." />
                        </div>
                        <div class="col-lg-6 col-12 px-3 mb-2">
                        ...
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            <label class="mb-1" for="20_kecamatan_kabupaten_kota">20. KECAMATAN - KABUPATEN / KOTA
                                (KODE
                                POS)</label>
                            <input {{ $disabled }} class="form-control"
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            ...
                            <input {{ $disabled }} class="form-control"
                                ...
                                id="23_zona_nilai_tanah" type="text" placeholder="Memuat..." />
                        </div>
                        <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            ...
                            <input {{ $disabled }} class="form-control"
                                ...
                                id="25_jumlah_bangunan" type="text" placeholder="Memuat..." />
                        </div>
                    </div>
                </div>
                <h4 class="fw-bold text-lg-center text-start my-3">
                        ...
                        <div class="col-12 d-flex flex-wrap mt-3">
                            ...
                            <ul>
                                ...
                                <li>- Dalam hal Subjek Pajak mendaftarkan Objek Pajak, supaya menggambarkan Sket/Denah
                                    ...
                                    Objek
                                    Pajak</li>
                                <li>- Batas waktu pengembalian SPOP 30 (tiga puluh) hari sejak diterima oleh Subjek
                                    Pajak
                                    sesuai
                                    Pasal
