                    ...
                    <div class="col-12 d-flex justify-content-between align-items-center mb-3 flex-wrap">
                        <div class="col d-flex justify-content-start">
                            <div class="px-lg-1 pe-1 ps-1 d-flex  justify-content-end">
                                ...
                                <button wire:click="addTrue" class="btn badge btn-primary btn-sm rounded-pill">Tambah Dati 2</button>
                            </div>
                        </div>
                        <div
    ...
    @else
        <div class="div">
            ...
            <div class="col-lg-5 col-6 mb-2  mt-3">
                ...
                <input required class="form-control" wire:model.defer="NM_DATI2" name="2_nop_kabupaten"
                    type="text" placeholder="Masukkan Nama Dati2" />
                @error('NM_DATI2')
