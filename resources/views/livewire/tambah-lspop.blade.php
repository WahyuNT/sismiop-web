                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-lg-2 col-6 mb-2 px-lg-3 px-1">
                                ...
                                <input maxlength="3" class="form-control" wire:model="data.2_nop_kecamatan"
                                    name="2_nop_kecamatan" id="2_nop_kecamatan" type="text" placeholder="..." />
                            </div>
                            <div class="col-lg-2 col-6 mb-2 px-lg-3 px-1">
                ...
                <div class="d-flex flex-wrap">
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        <label class="text-black  " for="10_daya_listrik_terpasang">10. Daya
                            ...
                            Terpasang
                            (Watt)</label>
                        <input maxlength="10" class="form-control" wire:model="data.10_daya_listrik_terpasang"
                    ...
                    <div class="col-lg-6 col-12 mb-2 px-lg-3 px-1 mb-2">
                        ...
                        <select id="14_dinding" wire:model="data.14_dinding" name="14_dinding" class="form-select">
                            <option value="">Silahkan Pilih</option>
                ...
                <div class="d-flex flex-wrap">
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        ...
                        <div class="d-flex flex-wrap align-items-center ">
                            ...
                            <div class="col-4  pe-2">
                                <input maxlength="2" class="form-control" wire:model="data.21_beton_dengan_lampu"
                        ...
                        <div class="d-flex flex-wrap align-items-center mt-3">
                            ...
                            <div class="col-4  pe-2">
                                <input maxlength="2" class="form-control" wire:model="data.21_aspal_dengan_lampu"
                        ...
                        <div class="d-flex flex-wrap align-items-center mt-3">
                            ...
                            <div class="col-4  pe-2">
                                <input maxlength="2" class="form-control" wire:model="data.21_tanah_dengan_lampu"
