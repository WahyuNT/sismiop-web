        ...
        <form wire:submit.prevent="simpan">
            ...
            <div class="card card-form">
                <div class="col-lg-4 col-12 mb-2 px-lg-3 px-1">
                    ...
                    <input maxlength="9" wire:model.defer="data.no_formulir" class="form-control" name="no_formulir"
                    ...
                    <div class="d-flex justify-content-start flex-wrap gap-2">
                        <div class="form-check radio-style mb-20">
                            <input maxlength="9" class="form-check-input" type="radio" value="1"
                                id="radio-transaksi-1" wire:model.defer="data.1_jenis_transaksi" name="1_jenis_transaksi" />
                    ...
                    <div class="col-12 px-lg-3 px-0">
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-lg-2 col-6 mb-2 px-lg-3 px-1">
                                ...
                                <input required maxlength="2" class="form-control" wire:model.defer="data.2_nop_kabupaten"
                                    name="2_nop_kabupaten" id="2_nop_kabupaten" type="text" placeholder="..." />
                            </div>
                            <div class="col-lg-2 col-6 mb-2 px-lg-3 px-1">
                            ...
                            <div class="col-lg-2 col-6 mb-2 px-lg-3 px-1">
                                ...
                                <input required disabled maxlength="4" class="form-control" wire:model.defer="data.2_nop_no_urut"
                    ...
                    {{-- <div class="d-flex flex-wrap px-lg-3 px-0">
                        <div class="col-lg-6 col-12 mb-2   px-1 ">
                            <label class="text-black  mb-1" for="3_jumlah_bangunan">3. Jumlah
                                Bangunan</label>
                            <input maxlength="3" class="form-control" wire:model.defer="data.3_jumlah_bangunan"
                                name="3_jumlah_bangunan" id="jumlah_bangunan" type="text" placeholder="..." />
                        </div>
                        <div class="col-lg-6 col-12 mb-2  px-lg-3 px-1">
                            <label class="text-black  mb-1" for="4_bangunan_ke">4. Bangunan Ke</label>
                            <input maxlength="3" class="form-control" wire:model.defer="data.4_bangunan_ke"
                ...
                <div class="d-flex flex-wrap">
                    <div class="col-lg-6 col-12 mb-2 px-lg-3 px-1 ">
                        <label class="text-black " for="5_jenis_penggunaan_bangunan">5. Jenis Penggunaan
                            Bangunan</label>
                        <select name="5_jenis_penggunaan_bangunan" wire:model.defer="data.5_jenis_penggunaan_bangunan"
                            id="5_jenis_penggunaan_bangunan" class="form-select">
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        <label class="text-black  " for="6_luas_bangunan">6. Luas
                            Bangunan(M2)</label>
                        <input maxlength="10" class="form-control" wire:model.defer="data.6_luas_bangunan"
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        ...
                        <input maxlength="2" class="form-control" wire:model.defer="data.7_jumlah_lantai"
                            name="7_jumlah_lantai" id="7_jumlah_lantai" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        <label class="text-black  " for="8_tahun_dibangun">8. Tahun
                            Dibangun</label>
                        <input maxlength="4" class="form-control" wire:model.defer="data.8_tahun_dibangun"
                            name="8_tahun_dibangun" id="8_tahun_dibangun" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        <label class="text-black  " for="9_tahun_direnovasi">9. Tahun
                            Direnovasi</label>
                        <input maxlength="4" class="form-control" wire:model.defer="data.9_tahun_direnovasi"
                            name="9_tahun_direnovasi" id="9_tahun_direnovasi" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        <label class="text-black  " for="10_daya_listrik_terpasang">10. Daya
                            ...
                            Terpasang
                            (Watt)</label>
                        <input maxlength="10" class="form-control" wire:model.defer="data.10_daya_listrik_terpasang"
                    ...
                    <div class="col-lg-6 col-12 mb-2 px-lg-3 px-1 mb-2">
                        ...
                        <select id="13_atap" wire:model.defer="data.13_atap" name="13_atap" class="form-select">
                            <option value="">Silahkan Pilih</option>
                    ...
                    <div class="col-lg-6 col-12 mb-2 px-lg-3 px-1 mb-2">
                        ...
                        <select id="14_dinding" wire:model.defer="data.14_dinding" name="14_dinding" class="form-select">
                            <option value="">Silahkan Pilih</option>
                    ...
                    <div class="col-lg-6 col-12 mb-2 px-lg-3 px-1 mb-2">
                        ...
                        <select name="15_lantai" id="15_lantai" wire:model.defer="data.15_lantai" class="form-select">
                            <option value="">Silahkan Pilih</option>
                    ...
                    <div class="col-lg-6 col-12 mb-2 px-lg-3 px-1 mb-2">
                        ...
                        <select name="16_langit_langit" wire:model.defer="data.16_langit_langit" id="16_langit_langit"
                            class="form-select">
                            <option value="">Silahkan Pilih</option>
                ...
                <div class="d-flex flex-wrap">
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="col-lg-3 col-6 px-2">
                                ...
                                <input maxlength="2" class="form-control" wire:model.defer="data.17_ac_split"
                                    name="17_ac_split" id="17_ac_split" type="text" placeholder="..." />
                            </div>
                            <div class="col-lg-3 col-6 px-2">
                                <label class="text-black " for="17_ac_window">Window</label>
                                <input maxlength="2" class="form-control" wire:model.defer="data.17_ac_window"
                        ...
                        <div class="d-flex flex-wrap ">
                            <div class="col-lg-6 col-12 pe-lg-3">
                                <label class="text-black  " for="19_luas_kolam_renang">19. Luas Kolam
                                    Renang(M2)</label>
                                <input maxlength="4" class="form-control" wire:model.defer="data.19_luas_kolam_renang"
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-6 px-2">
                                ...
                                <input maxlength="5" class="form-control"
                                    ...
                                    id="20_luas_perkerasan_halaman_sedang=sedang" type="text" placeholder="..." />
                            </div>
                            <div class="col-6 px-2">
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        ...
                        <div class="d-flex flex-wrap align-items-center ">
                            ...
                            <div class="col-4  pe-2">
                                <input maxlength="2" class="form-control" wire:model.defer="data.21_beton_dengan_lampu"
                                    name="21_beton_dengan_lampu" id="21_beton_dengan_lampu" type="text"
                                    placeholder="..." />
                            </div>
                            <div class="col-4">
                                <input maxlength="2" class="form-control" wire:model.defer="data.21_beton_tanpa_lampu"
                        ...
                        <div class="d-flex flex-wrap align-items-center mt-3">
                            ...
                            <div class="col-4  pe-2">
                                <input maxlength="2" class="form-control" wire:model.defer="data.21_aspal_dengan_lampu"
                                    name="21_aspal_dengan_lampu" id="21_aspal_dengan_lampu" type="text"
                                    placeholder="..." />
                            </div>
                            <div class="col-4">
                                <input maxlength="2" class="form-control" wire:model.defer="data.21_aspal_tanpa_lampu"
                        ...
                        <div class="d-flex flex-wrap align-items-center mt-3">
                            ...
                            <div class="col-4  pe-2">
                                <input maxlength="2" class="form-control" wire:model.defer="data.21_tanah_dengan_lampu"
                                    name="21_tanah_dengan_lampu" id="21_tanah_dengan_lampu" type="text"
                                    placeholder="..." />
                            </div>
                            <div class="col-4">
                                <input maxlength="2" class="form-control" wire:model.defer="data.21_tanah_tanpa_lampu"
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        ...
                        <div class="d-flex flex-wrap align-items-center mt-3">
                            <div class="col-6 col-lg-3  pe-2">
                                <input maxlength="2" class="form-control" wire:model.defer="data.22_lift_penumpang"
                        ...
                        <div class="d-flex flex-wrap align-items-center mt-3">
                            <div class="col-6 col-lg-3  pe-2">
                                <input maxlength="2" class="form-control" wire:model.defer="data.22_kapsul"
                        ...
                        <div class="d-flex flex-wrap align-items-center mt-3">
                            <div class="col-6 col-lg-3  pe-2">
                                <input maxlength="2" class="form-control" wire:model.defer="data.22_barang"
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="col-lg-6 col-12 px-lg-3 px-0">
                                <label class="text-black  mb-1 mt-" for="24_panjang_pagar">24. Panjang
                                    Pagar(M2)</label>
                                <input maxlength="4" class="form-control" wire:model.defer="data.24_panjang_pagar"
                            ...
                            <div class="col-lg-6 col-12 px-lg-3 px-0 ">
                                <label class="text-black  mb-1 " for="24_bahan_pagar">Bahan
                                    Pagar(M2)</label>
                                <select id="24_bahan_pagar" wire:model.defer="data.24_bahan_pagar" name="24_bahan_pagar"
                                    class="form-select">
                                    <option value="">Silahkan Pilih</option>
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 mb-2">
                        <label class="text-black  mb-1 " for="26_jumlah_saluran_pes_pabx">26. JUMLAH
                            SALURAN PES.
                            PABX</label>
                        <input maxlength="4" class="form-control" wire:model.defer="data.26_jumlah_saluran_pes_pabx"
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 my-2">
                        <label class="text-black  mb-1 " for="27_kedalaman_sumur_artetis">27.
                            ...
                            SUMUR ARTETIS
                            (M)</label>
                        <input maxlength="4" class="form-control" wire:model.defer="data.27_kedalaman_sumur_artetis"
                ...
                <div class="d-flex flex-wrap">
                    <div class="col-lg-6 col-12 px-lg-3 px-1 my-2">
                        <label class="text-black  mb-1 " for="28_tinggi_kolong">28. TINGGI KOLOM
                            (M)</label>
                        <input maxlength="2" class="form-control" wire:model.defer="data.28_tinggi_kolong"
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 my-2">
                        <label class="text-black  mb-1 " for="29_lebar_bentang">29. LEBAR BENTANG
                            (M)</label>
                        <input maxlength="2" class="form-control" wire:model.defer="data.29_lebar_bentang"
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 my-2">
                        <label class="text-black  mb-1 " for="30_daya_dukung_lantai">30. DAYA DUKUNG
                            LANTAI
                            (Kg/M²)</label>
                        <input maxlength="4" class="form-control" wire:model.defer="data.30_daya_dukung_lantai"
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 my-2">
                        <label class="text-black  mb-1 " for="31_keliling_dinding">31. KELILING DINDING
                            (M)</label>
                        <input maxlength="4" class="form-control" wire:model.defer="data.31_keliling_dinding"
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1 my-2">
                        <label class="text-black  mb-1 " for="32_luas_mezzanine">32. LUAS MEZZANINE
                            (M2)</label>
                        <input maxlength="4" class="form-control" wire:model.defer="data.32_luas_mezzanine"
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-lg-6 col-12 pe-lg-2">
                                <label class="text-black mt-2  mb-0 " for="41_jumlah_kamar">41. JUMLAH
                                    KAMAR</label>
                                <input maxlength="4" class="form-control" wire:model.defer="data.41_jumlah_kamar"
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-lg-6 col-12  ps-lg-2">
                                <label class="text-black  mb-1 mt-1" for="46_jumlah_apartemen">46.JUMLAH
                                    APARTEMEN </label>
                                <input maxlength="5" class="form-control" wire:model.defer="data.46_jumlah_apartemen"
                        ...
                        <div class=" d-flex flex-wrap">
                            <div class="col-lg-6 col-12 pe-lg-2 ps-lg-0  px-0 ">
                                <label class="text-black  mb-1 mt-1" for="49_kapasitas_tangki">49. KAPASITAS
                                    TANGKI (M3)</label>
                                <input maxlength="5" class="form-control" wire:model.defer="data.49_kapasitas_tangki"
                            ...
                            <div class="col-lg-6 col-12 ps-lg-2  pe-lg-0 px-0 ">
                                ...
                                <select id="50_letak_tangki" name="50_letak_tangki" wire:model.defer="data.50_letak_tangki"
                                    class="form-select">
                                    <option value="">Silahkan Pilih</option>
            ...
            <div class="card card-form ">
                <div class="d-flex flex-wrap">
                    ...
                    <div class="col-12 col-lg-6 px-lg-3 px-1 ">
                        ...
                        <input maxlength="10" class="form-control" wire:model.defer="data.52_nilai_sistem"
                    ...
                    <div class="col-12 col-lg-6 px-lg-3 px-1 ">
                        <label class="text-black  mb-1 mt-2 " for="53_nilai_individual">53. NILAI
                            INDIVIDUAL</label>
                        <input maxlength="10" class="form-control" wire:model.defer="data.53_nilai_individual"
            ...
            <div class="card card-form ">
                <div class="d-flex flex-wrap">
                    <div class="col-lg-6 col-12 px-lg-3 px-1">
                        ...
                        <div class="col-12">
                            <label class="text-black  mb-1 mt-2 " for="54_tanggal_kunjungan_kembali">54.
                                TANGAL
                                KUNJUNGAN
                                KEMBALI</label>
                        ...
                        <div class="col-12">
                            <label class="text-black mt-2 mb-1 " for="55_tanggal_pendataan">55. TANGAL
                                PENDATAAN</label>
                        ...
                        <div class="col-12">
                            <label class="text-black mt-2 mb-1 " for="56_tanda_tangan">56. TANDA
                                TANGAN</label>
                            <div class="card sign-ttd">
                                ...
                                <textarea hidden wire:model.defer="data.56_tanda_tangan" name="56_tanda_tangan" id="tanda_tangan_56"></textarea>
                        ...
                        <div class="col-12  px-lg-0 px-0 ">
                            ...
                            <input maxlength="18" class="form-control" wire:model.defer="data.58_nip" name="58_nip"
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-1">
                        ...
                        <div class="col-12">
                            <label class="text-black mt-2 mb-1 " for="60_tanda_tangan">60. TANDA
                                TANGAN</label>
                            <div class="card sign-ttd">
                                <div class="wrapper-sign" id="tempatTTD" style="display: block">
                                ...
                                <textarea hidden wire:model.defer="data.60_tanda_tangan" name="60_tanda_tangan" id="tanda_tangan_60"></textarea>
                                <div class="d-flex justify-content-center">
                                    <button type="button" class="btn rounded-pill btn-danger py-0 mb-2"
                        ...
                        <div class="col-12   px-0 ">
                            ...
                            <input maxlength="18" class="form-control" wire:model.defer="data.62_nip" name="62_nip"
