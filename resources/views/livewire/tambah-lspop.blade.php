<div>
    <div class="container-fluid">
                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="col-lg-2 col-12 mb-2 px-1">
                                    ...
                                    <input class="form-control" wire:model="data.2_nop_no_urut" name="2_nop_no_urut"
                ...
                <div class="card card-form">
                    <div class="d-flex flex-wrap">
                        <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                            ...
                            <select name="5_jenis_penggunaan_bangunan" wire:model="data.5_jenis_penggunaan_bangunan"
                        ...
                        <div class="col-lg-6 col-12 px-3 mb-2">
                            ...
                            <input class="form-control" wire:model="data.8_tahun_dibangun" name="8_tahun_dibangun"
                                id="8_tahun_dibangun" type="text" placeholder="Masukkan Data" />
                        </div>
                        <div class="col-lg-6 col-12 px-3 mb-2">
                        ...
                        <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                            ...
                            <select name="15_lantai" id="15_lantai" wire:model="data.15_lantai" class="form-select">
                                <option value="">Silahkan Pilih</option>
                        ...
                        <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                            ...
                            <select name="16_langit_langit" wire:model="data.16_langit_langit" id="16_langit_langit"
                                class="form-select">
                                <option value="">Silahkan Pilih</option>
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-6 px-2 ">
                                <label class="text-black fw-bold mb-1 fw-bold" for="24_bahan_pagar">Bahan
                                    Pagar(M2)</label>
                                <select id="24_bahan_pagar" wire:model="data.24_bahan_pagar" name="24_bahan_pagar"
                                    class="form-select">
                                    <option value="">Silahkan Pilih</option>
            ...
            <div class="d-flex flex-wrap">
                ...
                <div class="col-lg-6 col-12 px-3 my-2">
                    <label class="text-black fw-bold mb-1 fw-bold" for="30_daya_dukung_lantai">30. DAYA DUKUNG LANTAI
                        (Kg/M²)</label>
                    <input class="form-control" wire:model="data.30_daya_dukung_lantai" name="30_daya_dukung_lantai"
                        id="30_daya_dukung_lantai" type="text" placeholder="Masukkan Data" />
                </div>
                <div class="col-lg-6 col-12 px-3 my-2">
        ...
        <button class="btn btn-primary w-100 mt-3" wire:click="simpan" type="button">submit</button>
    </div>
</div>
