            ...
            <div class="card card-form">
                <div class="d-flex flex-wrap">
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        ...
                        <input maxlength="30" class="form-control" wire:model="data.6_nama_jalan"
                            name="6_nama_jalan" id="6_nama_jalan" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        <label class="text-black mb-1" for="7_blok_kav_nomor">7. BLOK / KAV / NOMOR</label>
                        <input maxlength="12" class="form-control" wire:model="data.7_blok_kav_nomor"
                            name="7_blok_kav_nomor" id="7_blok_kav_nomor" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        <label class="text-black mb-1" for="8_gampong">8. GAMPONG</label>
                        <input maxlength="25" class="form-control" wire:model="data.8_gampong" name="8_gampong"
                            id="8_gampong" type="text" placeholder="..." />
                    </div>
                    <div class="col-12 col-lg-6 d-flex flex-wrap">
                        ...
                        <div class="col-lg-6 col-6 px-lg-3 pe-3 px-0 mb-2">
                            ...
                            <input maxlength="2" class="form-control" wire:model="data.9_rw" name="9_rw"
                                id="9_rw" type="text" placeholder="..." />
                        </div>
                        <div class="col-lg-6 col-6 px-lg-3 px-0 mb-2">
                            <label class="text-black mb-1" for="10_rt">10. RT</label>
                            <input maxlength="2" class="form-control" wire:model="data.10_rt" name="10_rt"
                                id="10_rt" type="text" placeholder="..." />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-form">
                <div class="d-flex flex-wrap">
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        ...
                        <input maxlength="30" class="form-control" wire:model="data.13_nama_subjek_pajak"
                            name="13_nama_subjek_pajak" id="13_nama_subjek_pajak" type="text"
                            placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        <label class="text-black mb-1" for="14_npwp">14. NPWP</label>
                        <input maxlength="11" class="form-control" wire:model="data.14_npwp" name="14_npwp"
                            id="14_npwp" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        <label class="text-black mb-1" for="15_nama_jalan">15. NAMA JALAN</label>
                        <input maxlength="30" class="form-control" wire:model="data.15_nama_jalan"
                            name="15_nama_jalan" id="15_nama_jalan" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        <label class="text-black mb-1" for="16_blok_kav_nomor">16. BLOK / KAV / NOMOR</label>
                        <input maxlength="12" class="form-control" wire:model="data.16_blok_kav_nomor"
                            name="16_blok_kav_nomor" id="16_blok_kav_nomor" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        <label class="text-black mb-1" for="17_gampong">17. GAMPONG</label>
                        <input maxlength="25" class="form-control" wire:model="data.17_gampong" name="17_gampong"
                            id="17_gampong" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 d-flex flex-wrap">
                        ...
                        <div class="col-lg-6 col-6 pe-3 px-lg-3 px-0 mb-2">
                            ...
                            <input maxlength="2" class="form-control" wire:model="data.18_rw" name="18_rw"
                                id="18_rw" type="text" placeholder="..." />
                        </div>
                        <div class="col-lg-6 col-6 px-lg-3 px-0 mb-2">
                            <label class="text-black mb-1" for="19_rt">19. RT</label>
                            <input maxlength="3" class="form-control" wire:model="data.19_rt" name="19_rt"
                                id="19_rt" type="text" placeholder="..." />
                        </div>
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        <label class="text-black mb-1" for="20_kecamatan_kabupaten_kota">20. KECAMATAN - KABUPATEN /
                            KOTA (KODE
                            POS)</label>
                        <input maxlength="25" class="form-control" wire:model="data.20_kecamatan_kabupaten_kota"
                    ...
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        ...
                        <input maxlength="20" class="form-control" wire:model="data.21_nomor_ktp"
            ...
            <div class="card card-form">
                <div class="d-flex flex-wrap">
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        ...
                        <input maxlength="10" class="form-control" wire:model="data.22_luas_tanah"
                            name="22_luas_tanah" id="22_luas_tanah" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 px-lg-3 px-0 mb-2">
                        <label class="text-black mb-1" for="23_zona_nilai_tanah">23. ZONA NILAI TANAH</label>
                        <input maxlength="2" class="form-control" wire:model="data.23_zona_nilai_tanah"
                            name="23_zona_nilai_tanah" id="23_zona_nilai_tanah" type="text" placeholder="..." />
                    </div>
                    <div class="col-lg-6 col-12 mb-2 px-lg-3 px-0 mb-2">
            ...
            <div class="card card-form">
                <div class="d-flex flex-wrap">
                    <div class="col-lg-12 col-12 px-lg-3 px-0 mb-2">
                        ...
                        <input maxlength="3" class="form-control" wire:model="data.25_jumlah_bangunan"
                            name="25_jumlah_bangunan" id="25_jumlah_bangunan" type="text" placeholder="..." />
                    </div>
                </div>
            </div>
            <h4 class="fw-bold text-lg-center text-start my-3">
            ...
            <div class="card card-form">
                <div class="d-flex flex-wrap">
                    ...
                    <div class="col-12 d-flex flex-wrap mt-3">
                        ...
                        <div class="col-12 col-lg-4 px-lg-3 px-0">
                            <p class="text-center fw-bold text-black mt-3 mt-lg-0">27. TANGGAL</p>
                            <div class="card border-0 ">
                                <div class="mt-5"></div>
                                <div class="mt-5"></div>
            ...
            <div class="card card-form">
                <div class="d-flex flex-wrap">
                    ...
                    <div class="col-12 col-lg-6 px-lg-3 px-0">
                        ...
                        <div class="col-12">
                            <label class="text-black mt-2 mb-1" for="31_nama_jelas_petugas">31. NAMA JELAS</label>
                        ...
                        <div class="col-12">
                            <label class="text-black mt-2 mb-1" for="32_nip_petugas">32. NIP</label>
                            <input maxlength="18" class="form-control" wire:model="data.32_nip_petugas"
