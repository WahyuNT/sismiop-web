            ...
            <div class="col-12 d-flex justify-content-between align-items-center mb-3 flex-wrap">
                <div class="col d-flex justify-content-start">
                    <div class="px-lg-1 pe-1 ps-1 d-flex  justify-content-end">
                        <a href="{{ route('berita.tambah') }}">
                            <button class="btn badge btn-primary btn-sm rounded-pill">Tambah Provinsi</button>
                        </a>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="col-lg-8 col-6 ps-lg-1 ps-1 ">
                        <input wire:model="search" type="text" class="form-control" placeholder="Cari Provinsi">
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <td
                                        ...
                                        @if ($confirmDelete != $item->id)
                                            <a href="{{ route('berita.edit', $item->id) }}">
                                                <button class="btn badge btn-primary rounded-pill mx-1">Edit</button>
                                            </a>
                                            <div class="div">
