                        ...
                        <div class="d-flex justify-content-start gap-2">
                            <div class="form-check radio-style mb-20">
                                <input {{ $disabled }} class="form-check-input" type="radio"
                                    value="perekaman_data" id="radio-transaksi-1"
                                    wire:model.defer="data.1_jenis_transaksi" name="1_jenis_transaksi" required />
                            ...
                            <div class="form-check radio-style mb-20">
                                <input {{ $disabled }} class="form-check-input" type="radio"
                                    value="pemutakhiran_data" id="radio-transaksi-2"
                            ...
                            <div class="form-check radio-style mb-20">
                                <input {{ $disabled }} class="form-check-input" type="radio"
                                    value="penghapusan_data" id="radio-transaksi-3"
                                    wire:model.defer="data.1_jenis_transaksi" name="1_jenis_transaksi" />
                            ...
                            <div class="form-check radio-style mb-20">
                                <input {{ $disabled }} class="form-check-input" type="radio"
                                    value="penilaian_individu" id="radio-transaksi-4"
                                    wire:model.defer="data.1_jenis_transaksi" name="1_jenis_transaksi" />
                ...
                <div class="card card-form">
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                            ...
                            <select {{ $disabled }} id="13_atap" wire:model.defer="data.13_atap"
                                name="13_atap" class="form-select">
                                <option value="">Silahkan Pilih</option>
                        ...
                        <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                            ...
                            <select {{ $disabled }} id="14_dinding" wire:model.defer="data.14_dinding"
                                name="14_dinding" class="form-select">
                                <option value="">Silahkan Pilih</option>
                        ...
                        <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                            ...
                            <select {{ $disabled }} name="15_lantai" id="15_lantai"
                                wire:model.defer="data.15_lantai" class="form-select">
                                <option value="">Silahkan Pilih</option>
                        ...
                        <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                            ...
                            <select {{ $disabled }} name="16_langit_langit"
                                wire:model.defer="data.16_langit_langit" id="16_langit_langit" class="form-select">
                                <option value="">Silahkan Pilih</option>
                ...
                <div class="d-flex flex-wrap">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-6 px-2">
                                <label class="text-black fw-bold mb-1" for="19_tipe_kolam_renang">Tipe Kolam
                                    Renang</label>
                                <select id="19_tipe_kolam_renang" {{ $disabled }}
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-6 px-2 ">
                                <label class="text-black fw-bold mb-1 fw-bold" for="24_bahan_pagar">Bahan
                                    Pagar(M2)</label>
                                <select {{ $disabled }} id="24_bahan_pagar"
                                    wire:model.defer="data.24_bahan_pagar" name="24_bahan_pagar" class="form-select">
                                    <option value="">Silahkan Pilih</option>
                    ...
                    <div class="col-lg-6 col-12 mb-2 px-3 mb-2">
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div class="col-6 d-flex flex-wrap">
                                <div class="form-check radio-style">
                                    <input {{ $disabled }} wire:model.defer="data.sprinkler"
                                        class="form-check-input" type="radio" value="ada" name="25_sprinkler"
                                        id="sprinkler-1" />
                                ...
                                <div class="form-check radio-style">
                                    <input {{ $disabled }} wire:model.defer="data.sprinkler"
                                        class="form-check-input" type="radio" value="tidak" name="25_sprinkler"
                                        id="sprinkler-2" />
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div class="col-6 d-flex flex-wrap">
                                <div class="form-check radio-style">
                                    <input {{ $disabled }} wire:model.defer="data.25_fireA1"
                                        class="form-check-input" type="radio" value="ada" name="25_fireA1"
                                        id="fireA1-1" />
                                ...
                                <div class="form-check radio-style">
                                    <input {{ $disabled }} wire:model.defer="data.25_fireA1"
                                        class="form-check-input" type="radio" value="tidak" name="25_fireA1"
                                        id="fireA1-2" />
